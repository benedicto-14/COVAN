...
class controladorEmpleado{  
    ...
    public function mostrarDatos($idS){
      $datos=array();  
    $reg=$this->modelo->consultarEmpleado($idS);
    ...
    return json_encode($datos);
     ...
     public function mostrarEmpleadosbyNombre($idS,$nombre){
      $datos=array();  
    $reg=$this->modelo->consultarEmpleadobyNombre($idS,$nombre);
    ...
    public function validarNombreU($nombre,$idEmpresa){
      $datos=array();  
    $reg=$this->modelo->consultarNombreUsuario($nombre, $idEmpresa);
...
//    }
    ...
    public function datosUsuario($usuario, $pass, $idEmpleadoU,$tipoUsuario,$idEmpresa ) {
        $reg=$this->modelo->agregarNuevoUsuario($usuario, $pass, $idEmpleadoU,$tipoUsuario,$idEmpresa);
    }
